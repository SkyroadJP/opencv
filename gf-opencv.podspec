...
Pod::Spec.new do |spec|
  ...
  spec.description  = <<-DESC
                 this is the repo for opencv with customizations
                   DESC

  spec.homepage     = "https://github.com/SkyroadJP"
  ...
  spec.author             = { "Zongyao QU" => "zongyao.qu@gmail.com" }
  # Or just: spec.author    = "Zongyao QU"
  # spec.authors            = { "Zongyao QU" => "zongyao.qu@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Zongyao QU"
  ...
  spec.frameworks = "Accelerate", "AVFoundation", "CoreGraphics", "CoreImage", "CoreMedia", "CoreVideo", "Foundation", "QuartzCore", "UIKit"
